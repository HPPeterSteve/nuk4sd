...
/* ═══════════════════════════════════════════════════════════════════════════
 *  WORM bits (espelha vault_core.h — sem incluir para evitar dependência
 *  circular quando vault_cli_log.c for compilado standalone)
 * ═══════════════════════════════════════════════════════════════════════════ */
...
void cli_log_seccomp(int result) {
    if (result == 0) {
        cli_log(CLI_LOG_SEC, "SECCOMP",
                ...
                "(política: SCMP_ACT_KILL_PROCESS para syscalls fora da allowlist)");
    } else {
